...
function Footer({footer}) {
    ...
    return <div className={Style.footer}>
        ...
        <footer className="p-4 bg-transparent sm:p-6 dark:bg-gray-900 text-white">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="FlowBite Logo"/>
                        <span
                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Zmax</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            ...
                            <li className={'my-4'}>
                                <a href="/" className="hover:underline text-gray-400">About</a>
                            </li>
                            <li>
                                <a href="/" className="hover:underline text-gray-400">Contacts</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-white">Follow
                            us</h2>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li>
                            ...
                            <li>
                                <a href="#" className="hover:underline text-gray-400">Yelp</a>
                            </li>
                        </ul>
                    </div>
                    <div>
        ...
        <span className="text-sm text-gray-400 sm:text-center dark:text-gray-300">© 2023 <a href="#"
                                                                                            className="hover:underline">Zmax™</a>. All Rights Reserved.
        </span>
